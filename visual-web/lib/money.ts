// Money primitives — copied verbatim from packages/kickback/src/money.ts so this
// app stays self-contained (Plan 2 says "copy the tiny file or import"). Keep in
// sync with the canonical version if it ever changes.
//
